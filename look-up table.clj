...
(def lookup-table2 {0 {1},1 0},2 {0.82},3 {0},4 {0.74},5 {0},6 {0.66},7 {0},8 {0.58},9 {0},10 {0.5},11 {0},12 {0.42},13 {0},14 {0.34},15 {0},16 {0.26},17 {0},18 {0.18},19 {0},20 {0.10},21 {0},22 {0.02},23 {0}})
(def lookup-table {1 1, 2 3, 3 4, 4 3, 6 2, 8 3, 9 3, 10 2, 11 1, 12 0})
(def lookup-table {0 [1], 1 [0], 2 [0.82], 3 [0], 4 [0.74], 5 [0], 6 [0.66], 7 [0], 8 [0.58], 9 [0], 10 [0.5], 11 [0],12 [0.42], 13 [0],14 [0.34],15 [0] ,16 [0.26], 17 [0] , 18 [0.18], 19 [0] ,20 [0.10], 21 [0] ,22 [0.05] , 23 [0]})
