...
(defn transmit-patch [ch patch]
  (let [tx-scalars (fn [k]
    ...
    (async/put! ch [(str "/harmonics/toggle/0/1/10") (map float (subvec (-> patch :harmonics :toggle) 9 10))])
    (async/put! ch [(str "/harmonics/toggle/0/1/11") (map float (subvec (-> patch :harmonics :toggle) 10 11))])
    (async/put! ch [(str "/harmonics/toggle/0/1/12") (map float (subvec (-> patch :harmonics :toggle) 11 12))])
    (async/put! ch [(str "/harmonics/toggle/1/1/1") (map float (subvec (-> patch :harmonics :toggle) 12 13))])
    (async/put! ch [(str "/harmonics/toggle/1/1/2") (map float (subvec (-> patch :harmonics :toggle) 13 14))])
    (async/put! ch [(str "/harmonics/toggle/1/1/3") (map float (subvec (-> patch :harmonics :toggle) 14 15))])
    (async/put! ch [(str "/harmonics/toggle/1/1/4") (map float (subvec (-> patch :harmonics :toggle) 15 16))])
    (async/put! ch [(str "/harmonics/toggle/1/1/5") (map float (subvec (-> patch :harmonics :toggle) 16 17))])
    (async/put! ch [(str "/harmonics/toggle/1/1/6") (map float (subvec (-> patch :harmonics :toggle) 17 18))])
    (async/put! ch [(str "/harmonics/toggle/1/1/7") (map float (subvec (-> patch :harmonics :toggle) 18 19))])
    (async/put! ch [(str "/harmonics/toggle/1/1/8") (map float (subvec (-> patch :harmonics :toggle) 19 20))])
    (async/put! ch [(str "/harmonics/toggle/1/1/9") (map float (subvec (-> patch :harmonics :toggle) 20 21))])
    (async/put! ch [(str "/harmonics/toggle/1/1/10") (map float (subvec (-> patch :harmonics :toggle) 21 22))])
    (async/put! ch [(str "/harmonics/toggle/1/1/11") (map float (subvec (-> patch :harmonics :toggle) 22 23))])
    (async/put! ch [(str "/harmonics/toggle/1/1/12") (map float (subvec (-> patch :harmonics :toggle) 23 24))])
    ))
...
(osc/osc-handle server "/1"  (fn [_](for [i (range 10)] (transmit-patch cchan @apatch))))
